...
var __WLUtils = function () {
    ...
    var IBMMFPF_SDK_NAME = 'ibmmfpf-preview';

    function loadWLClientMessages(path, lang) {
        var dfd = WLJQ.Deferred();

        var url = 'messages/' + lang + '/messages.json';
...
WLResourceRequest = function (_url, _method, _options) {
    ...
    function sendRequestAsync(contentString, attempt, conflictAttemptCounter) {
		...
		if (WL.StaticAppProps.ENVIRONMENT === 'preview') {
		    ...
		    previewRootUrl = WL.StaticAppProps.PREVIEW_ROOT_URL;
		    previewUrlSplit = previewRootUrl.split('/');
		    serverRuntime = previewUrlSplit[previewUrlSplit.length - 2];
		    newUrl = 'http://localhost:6015/' + serverRuntime + '/api/' + endOfUrlPath;
...
/**
 * ================================================================= 
 * Source file taken from :: wlconfig.preview.js
 * ================================================================= 
 */
...
WL.Config.__getApplicationData = function () {
    var data = {};
    data['clientPlatform'] = WL.StaticAppProps.PREVIEW_ENVIRONMENT;
    data['id'] = WL.StaticAppProps.APP_ID;
    data['version'] = WL.StaticAppProps.APP_VERSION;
    return data;
}
